package com.example.a61685.coolweather.service;
...
public class AutoUpdateService extends Service {
    ...
    private void updateWeather(){
        ...
        if (weatherString != null){
            ...
            String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=76ef11c2c3034ea2934a8c3894e2d85b";
    ...
    private void updateBingPic(){
        final String responseBingPic = "http://guolin.tech/api/bong_pic";
        HttpUtil.sentOkHttpRequest(responseBingPic, new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                e.printStackTrace();
            }
