...
import com.example.a61685.coolweather.gson.Forecast;
import com.example.a61685.coolweather.gson.Weather;
import com.example.a61685.coolweather.service.AutoUpdateService;
...
public class WeatherActivity extends AppCompatActivity {
   ...
   private ImageView bingPicImg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bingPic != null){
            Glide.with(this).load(bingPicImg).into(bingPicImg);
        }else{
            loadBingPic();
        }
    ...
    public void requestWeather(final String weatherId){
        String weatherUri = "http://guolin.tech/api/weather?cityid=" + weatherId +
                "&key=76ef11c2c3034ea2934a8c3894e2d85b";
        HttpUtil.sentOkHttpRequest(weatherUri, new Callback() {
            @Override
